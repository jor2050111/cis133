...
Starter files for Skills Lab 6A: The Copperwind Site Gets Its Layout.
Students take Copperwind's spaced, typeset three-page site and give
...
| `starter-site/copperwind-styles.css` | Valid CSS, the site stylesheet as Skills Lab 5A finished it | Parts 1-3 |
...
`starter-site/` holds the Copperwind site exactly as Skills Lab 5A
left it: three pages connected to one external stylesheet,
`copperwind-styles.css`, now spaced with the box model and typeset for
