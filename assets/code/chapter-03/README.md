...
| File | Type | Used in |
| ---- | ---- | ------- |
| `recycling-guide-start.html` | Valid HTML, no landmarks | Parts 1-2 |
| `contact-start.html` | Valid HTML, no landmarks | Part 3 |
| `gallery-content.txt` | Plain text page content with [BRACKET] labels | Part 3 |
| `skills-lab-3a-answers.txt` | Plain text answer file (travels in the submission folder) | Parts 1-3, Questions & Analysis |
| 9 PNG images | See the image table below | Chapter examples, Parts 2-3 |
...
**recycling-guide-start.html** is the finished Skills Lab 2A guide
...
same landmarks and navigation as the other two pages.

**gallery-content.txt** holds the visible text of the new
`drive-gallery.html` page, labeled the same way as Chapter 2's
content file. It deliberately contains no alt text. Students write
every alt value by looking at the images.

**skills-lab-3a-answers.txt** holds numbered answer spaces: the
Part 1 landmark map, the Part 2 alt text log, the Part 3 format
decisions, and the Questions & Analysis section. It travels inside
the submission folder unrenamed.
