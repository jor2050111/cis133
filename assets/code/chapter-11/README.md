...
club site's signup form as an accessible, styled page, add it to
...
| `starter-site/club-styles.css` | Valid CSS, the site stylesheet as Skills Lab 10A finished it | Parts 1-3 |
| `starter-site/images/` | 7 PNG images, unchanged from the Chapter 10 pack | Parts 1-3 |
| `join-page-notes.txt` | The officers' field list for the join page, with the data promise | Parts 1-3 |
...
`starter-site/` holds the club's site exactly as Skills Lab 10A
...
The officers' notes for the join page: the two required fields, the
...
from the Chapter 10 pack. It maps the club's design set to exact
...
address uses the reserved example.org domain. The Campus Tutoring
