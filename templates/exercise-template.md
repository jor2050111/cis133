# Exercise Template (CIS133: Internet/Web Development Level I)
...
exercise meaningful to community college students in their first web development course. Scenarios should involve genuine
...
* 90% of CIS133 students should complete successfully
...
* 70% of CIS133 students should complete successfully
...
Add any of these blocks when a standalone exercise needs more scaffolding. Code samples below come from a Python-based course. Adapt them to HTML5, CSS3, VS Code, browser DevTools.

### Starter Code

```python
# EXAMPLE from a Python-based course. Adapt to HTML5, CSS3, VS Code, browser DevTools.
